...
public class TileEntityEnergyStorageBase extends LATile implements ITickable, IEnergyStorage, IInventory, IEnergyProvider, IEnergyReceiver {
    ...
    public TileEntityEnergyStorageBase(NonNullList inventory, int maxReceive, int maxExtract, int maxRF){
