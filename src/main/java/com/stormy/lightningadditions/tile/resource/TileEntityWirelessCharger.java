...
import com.stormy.lightningadditions.handler.EventHandler;
import com.stormy.lightninglib.lib.block.TileEntityBase;
...
public class TileEntityWirelessCharger extends TileEntityBase
{

    private static final int invSize = 1;

    public TileEntityWirelessCharger() { super(invSize); }
    ...
    { return new EnergyStorage(this).setMaxEnergyStored(100000).setMaxReceive(Integer.MAX_VALUE).setMaxExtract(2048).setEnergyStored(0); }
